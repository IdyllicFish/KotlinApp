...
package com.zhixin.kotlinapp.view.shimmer;
    ...
    public ShimmerFrameLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (attrs != null) {
            ...
            try {
                ...
                if (a.hasValue(R.styleable.ShimmerFrameLayout_sh_duration)) {
                    setDuration(a.getInt(R.styleable.ShimmerFrameLayout_sh_duration, 0));
                }
